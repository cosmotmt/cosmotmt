            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
              ...
              <div className="relative w-full md:w-64 aspect-square bg-slate-950 border border-white/10 overflow-hidden group/cover shrink-0 shadow-2xl">
                ...
                {work.audio_url && (
                  ...
                  >
                    <div className="w-16 h-16 flex items-center justify-center bg-white text-slate-950 rounded-full shadow-2xl transform transition-all hover:scale-110 md:group-hover/cover:bg-red-500 md:group-hover/cover:text-white cursor-pointer">
                      {isCurrent && isPlaying ? (
